...
_Static_assert(RTCTRL_MB_UAPI_ABI_VERSION == 2U,
               "test targets staged-I/O UAPI V2");
...
_Static_assert(_IOC_SIZE(RTCTRL_MB_IOC_GET_INFO) ==
                   sizeof(struct rtctrl_mb_info),
