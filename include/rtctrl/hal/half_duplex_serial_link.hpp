...
class HalfDuplexSerialLink final : public IActuatorLink {
  public:
    ...
    explicit HalfDuplexSerialLink(transport::IByteTransport& transport) noexcept
  ...
  private:
    ...
    static ActuatorLinkStatus map_status(transport::TransportStatus status) noexcept;
